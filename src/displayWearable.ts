...
export async function displayWearable() {
    ...
    const response = await fetch(
        'https://peer-testing.decentraland.org/lambdas/collections/wearables?collectionId=urn:decentraland:matic:collections-v2:0xae3d6cbe10cb4a0947c5e8362efb2802ab5098ab')
